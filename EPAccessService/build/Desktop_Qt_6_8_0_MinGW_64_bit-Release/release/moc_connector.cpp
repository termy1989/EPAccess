...
void Connector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalConnected((*reinterpret_cast< std::add_pointer_t<ldapcore::QLdap*>>(_a[1]))); break;
        ...
        {
            using _t = void (Connector::*)(ldapcore::QLdap * );
            if (_t _q_method = &Connector::signalConnected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Connector::*)(int );
            if (_t _q_method = &Connector::signalTimerStart; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Connector::signalTimerStop; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Connector::signalConnected(ldapcore::QLdap * _t1)
{
...
// SIGNAL 1
void Connector::signalTimerStart(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
